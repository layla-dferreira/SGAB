...
@WebServlet(name = "excluirController", urlPatterns = {"/excluirController"})
public class excluirController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("/view/resultadoExcluir.jsp"); // verificar caminho do arquivo
        ...
        private Assunto excluir(String tagAssuntoExcluido) { // Pode sofrer alteração dependendo do service
            ...
            resultado = service.excluir(tagAssuntoExcluido); // verificar se retorna alguma coisa
